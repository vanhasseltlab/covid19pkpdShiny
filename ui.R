  ...
  fluidRow(setSliderColor(rep("#001158",1000), 1:1000),
    ...
    box(width = NULL,
        ...
        conditionalPanel(condition = "input.drugname == 'Chloroquine'",
                         ...
                         conditionalPanel(condition = "input.ec50_1 == 'SARS-cov-1 2.81ug/ml (Keyaerts E et al. BBRC(2004))'",
                         ...
                         conditionalPanel(condition = "input.ec50_1 == 'SARS-cov-1 1.41ug/ml (Vincent MJ et al. Virol J(2005))'",
